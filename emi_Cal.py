...
st.markdown("<h1 style='font-size:24px;'>Advanced EMI Calculator for Indian Consumers - 2025</h1>", unsafe_allow_html=True)
...
# Sidebar for Inputs
st.sidebar.markdown("<h3 style='font-size:18px;'>Loan Type Selection</h3>", unsafe_allow_html=True)
...
st.sidebar.markdown("<h3 style='font-size:18px;'>Loan Details</h3>", unsafe_allow_html=True)
...
if st.sidebar.button("Calculate EMI"):
    ...
    st.sidebar.markdown(f"<h4 style='font-size:16px;'>Your Monthly EMI: ₹{emi:,.2f}</h4>", unsafe_allow_html=True)

# Main Content Layout
st.markdown("<h2 style='font-size:20px;'>Loan Summary</h2>", unsafe_allow_html=True)
st.markdown(f"<h3 style='font-size:18px;'>EMI: ₹{emi:,.2f}</h3>" if emi else "<h3 style='font-size:18px;'>EMI: -</h3>", unsafe_allow_html=True)

col1, col2 = st.columns([2, 1])

with col1:
    st.markdown("<h3 style='font-size:18px;'>Loan Balance Over Time</h3>", unsafe_allow_html=True)
    if emi:
...
with col2:
    st.markdown("<h3 style='font-size:18px;'>Payment Breakdown</h3>", unsafe_allow_html=True)
    if emi:
...
st.markdown("<h3 style='font-size:18px;'>Amortization Schedule</h3>", unsafe_allow_html=True)
if emi:
    st.dataframe(schedule)

st.markdown("<h3 style='font-size:18px;'>Download Report</h3>", unsafe_allow_html=True)
if emi:
    st.markdown(create_download_link(schedule), unsafe_allow_html=True)

# Right Sidebar with Additional Features
st.sidebar.markdown("<h3 style='font-size:18px;'>Loan Insights & Tips</h3>", unsafe_allow_html=True)
